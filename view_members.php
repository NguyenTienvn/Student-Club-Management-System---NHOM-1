...
// Lấy ID từ GET hoặc từ SESSION (ưu tiên GET)
...
<?php if ($result && $result->num_rows > 0): ?>
    <?php while ($member = $result->fetch_assoc()): 
        ...
        // Avatar - kiểm tra file thật
        $avatar_path_web  = "/Student-Club-Management-System---NHOM-1/assets/img/avatars/" . $avatar;
$avatar_path_disk = $_SERVER['DOCUMENT_ROOT'] . "/Student-Club-Management-System---NHOM-1/assets/img/avatars/" . $avatar;
